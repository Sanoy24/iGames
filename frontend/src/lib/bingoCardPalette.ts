...
export type BingoCardPaletteId =
    | 'blue'
    | 'orange'
    | 'purple'
    | 'teal'
...
export const BINGO_CARD_PALETTES: Record<BingoCardPaletteId, BingoCardPalette> =
    {
        blue: {
            ...
            ballGradient:
                'radial-gradient(circle at 35% 30%, #5eead4, #0f766e)',
        },
        orange: {
            id: 'orange',
            label: 'Orange',
            ...
            ballGradient:
                'radial-gradient(circle at 35% 30%, #fde047, #ca8a04)',
        },
        purple: {
            id: 'purple',
            label: 'Purple',
            ...
            ballGradient:
                'radial-gradient(circle at 35% 30%, #d8b4fe, #7e22ce)',
        },
        teal: {
            id: 'teal',
            label: 'Teal',
            ...
            ballGradient:
                'radial-gradient(circle at 35% 30%, #86efac, #15803d)',
        },
        pink: {
            id: 'pink',
            label: 'Pink',
...
export const BINGO_CARD_PALETTE_IDS = Object.keys(
    BINGO_CARD_PALETTES,
) as BingoCardPaletteId[];

export function getBingoCardPalette(
    id: string | null | undefined,
): BingoCardPalette {
    if (id && id in BINGO_CARD_PALETTES)
        return BINGO_CARD_PALETTES[id as BingoCardPaletteId];
