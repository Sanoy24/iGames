...
const poolEngine = fileURLToPath(
    new URL('../src/pool/engine/index.ts', import.meta.url),
);
const poolRules = fileURLToPath(
    new URL('../src/pool/rules/rules.ts', import.meta.url),
);
const poolRulesTypes = fileURLToPath(
    new URL('../src/pool/rules/rules-types.ts', import.meta.url),
);
const poolPhysics = fileURLToPath(
    new URL('../src/pool/pool-physics.ts', import.meta.url),
);
const werkSim = fileURLToPath(
    new URL('../src/werk/sim/index.ts', import.meta.url),
);
