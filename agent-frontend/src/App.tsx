...
export function App() {
    ...
    const [phase, setPhase] = useState<Phase>(
        isAuthenticated ? 'dashboard' : 'resolving',
    );
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            const { user, accessToken, refreshToken } =
                await authApi.loginWithCredentials(phone, password);
        ...
        content = (
            ...
            >
                <div style={{ maxWidth: 360, textAlign: 'center' }}>
                    ...
                    >
                        Open <strong>@yaho_agent_bot</strong> in Telegram, send
                        /start, and share your registered phone number. Then
                        come back and reopen this panel.
                    </p>
                </div>
            </div>
        );
