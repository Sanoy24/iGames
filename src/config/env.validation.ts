...
export function validateEnv(raw: Record<string, unknown>): EnvConfig {
    const config = {
        ...
        TELEGRAM_AUTH_MAX_AGE_SECONDS: readNumber(
            raw,
        ...
        TELEGRAM_AGENT_BOT_TOKEN: readString(
            raw,
            'TELEGRAM_AGENT_BOT_TOKEN',
            '',
        ),
        TELEGRAM_AGENT_BOT_WEBHOOK_URL: readString(
            raw,
        ...
        TELEBIRR_PROXY_TIMEOUT_MS: readNumber(
            raw,
        ...
        MPESA_PORTAL_TIMEOUT_MS: readNumber(
            raw,
            'MPESA_PORTAL_TIMEOUT_MS',
            15000,
        ),
        MPESA_PORTAL_STRICT: readBoolean(raw, 'MPESA_PORTAL_STRICT', false),
        ADMIN_BOOTSTRAP_ACCOUNTS: readString(
            raw,
