...
**Tests**: `npm run test:unit` — **228/228 pass**  
...
| Bingo â€” purchase-phase guard: final 3-second refund lock, auto-cancel when the last real player leaves, bot-only rooms refunded/reset before draw | Passing |
