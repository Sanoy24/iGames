import { findNearestLocation, GeoCandidate, haversineMeters } from './location-geo';
...
describe('findNearestLocation', () => {
  const bole: GeoCandidate = { id: 'bole', name: 'Bole', latitude: 8.9806, longitude: 38.7578, radiusMeters: 3000 };
  const megenagna: GeoCandidate = { id: 'meg', name: 'Megenagna', latitude: 9.0206, longitude: 38.8, radiusMeters: 3000 };
  const listOnly: GeoCandidate = { id: 'x', name: 'Remote', latitude: null, longitude: null, radiusMeters: 3000 };
